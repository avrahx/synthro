    ...
    <main>
      ...
      <section className="bg-[#06080D] py-20 px-6 flex flex-col items-center gap-6">
        ...
        <div
          className="w-px h-16"
          style={{
            background: "linear-gradient(180deg, transparent, rgba(13,242,164,0.4), transparent)",
          }}
        />

        {/* Section index */}
        <span className="protocol-label">005 // Deploy Capital</span>
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-gray-500 font-mono text-xs max-w-sm mx-auto tracking-wide">
